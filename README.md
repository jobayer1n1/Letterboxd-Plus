## Setup
1. **Download Latest Release:** Download the `.zip` file from the releases section
...
5. **Load the Extension:** Three new buttons will appear at the top-left. Have them click **Load unpacked**.
6. **Select the Folder:** select the unzipped letterboxd-plus folder
